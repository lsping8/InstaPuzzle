...
public class BaseGameUtils {
    ...
    public static boolean resolveConnectionFailure(Activity activity,
        ...
        if (result.hasResolution()) {
            Log.d(GoogleServiceApi.TAG,"result.hasResolution()");
            try {
                Log.d(GoogleServiceApi.TAG,"activity:" + activity);
                Log.d(GoogleServiceApi.TAG,"requestCode:" + requestCode);
                result.startResolutionForResult(activity, requestCode);
                return true;
            } catch (IntentSender.SendIntentException e) {
                Log.d(GoogleServiceApi.TAG,"IntentSender.SendIntentException");
